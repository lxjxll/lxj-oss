...
//模型的model3.json文件路径
var baseModelPath = 'https://cdn.jsdelivr.net/gh/lxjxll/lxj-oss@latest/assets/'
...
function loadCompleteHandler() {
    ...
    document.getElementById("live2dm").style.width = "400px"
    document.getElementById("live2dm").style.height = "350px"
    console.log('修改了大小')
}
